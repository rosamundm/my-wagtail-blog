...
class DjangoProject(Project):
    def download_repo(self,repo,nuke):
        ...
        subprocess.check_call(['git', 'clone', repo, stri(self.project_path)])
    ...
    def detect_requirements(self):
        requirements_txt = self.project_path / 'requirements_txt'
    ...
    def update_wsgi_file(self):
        print(snakesay('Updating wsgi file at mysite/wsgi.py'.format(wsgi_file_path=self.wsgi_file_path)))
